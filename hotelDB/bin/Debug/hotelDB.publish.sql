...
GO
PRINT N'Création de [dbo].[EquipementChambre]...';


GO
CREATE TABLE [dbo].[EquipementChambre] (
    [IdEquipementChambre] INT IDENTITY (1, 1) NOT NULL,
    [IdChambre]           INT NOT NULL,
    [IdEquipement]        INT NOT NULL,
    PRIMARY KEY CLUSTERED ([IdEquipementChambre] ASC)
);
...
GO
PRINT N'Création de [dbo].[PhotoChambre]...';


GO
CREATE TABLE [dbo].[PhotoChambre] (
    [IdPhotoChambre] INT         IDENTITY (1, 1) NOT NULL,
    [LienPhoto]      NCHAR (250) NOT NULL,
    [IdChambre]      INT         NOT NULL,
    PRIMARY KEY CLUSTERED ([IdPhotoChambre] ASC)
);
...
GO
PRINT N'Création de [dbo].[FK_Chambre_ToCategorie]...';


GO
ALTER TABLE [dbo].[Chambre]
    ADD CONSTRAINT [FK_Chambre_ToCategorie] FOREIGN KEY ([IdCategorie]) REFERENCES [dbo].[Categorie] ([IdCategorie]);


GO
PRINT N'Création de [dbo].[FK_Chambre_ToEquipement]...';


GO
ALTER TABLE [dbo].[Chambre]
    ADD CONSTRAINT [FK_Chambre_ToEquipement] FOREIGN KEY ([IdEquipement]) REFERENCES [dbo].[Equipement] ([IdEquipement]);
...
GO
ALTER TABLE [dbo].[EquipementChambre]
    ADD CONSTRAINT [FK_EquipementChambre_ToChambre] FOREIGN KEY ([IdChambre]) REFERENCES [dbo].[Chambre] ([IdChambre]);


GO
PRINT N'Création de [dbo].[FK_EquipementChambre_ToEquipement]...';


GO
ALTER TABLE [dbo].[EquipementChambre]
    ADD CONSTRAINT [FK_EquipementChambre_ToEquipement] FOREIGN KEY ([IdEquipement]) REFERENCES [dbo].[Equipement] ([IdEquipement]);
...
GO
ALTER TABLE [dbo].[PhotoChambre]
    ADD CONSTRAINT [FK_PhotoChambre_ToChambre] FOREIGN KEY ([IdChambre]) REFERENCES [dbo].[Chambre] ([IdChambre]);
