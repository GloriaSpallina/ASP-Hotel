...
namespace hotel.Models
{
    ...
    {
        private string _titre, _auteur, _phototAuteur, _textAuteur, _categorie, _photo, _article, _evidenceTexte, _nomLikeur, _lienArticle, _resume, _para1, _para2, _para3, _para4;
